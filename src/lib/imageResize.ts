// Ridimensiona un'immagine prima dell'upload
// logoSquadra: 120x120px (quadrato)
// logoPSponsor: 240x120px (rettangolare orizzontale)
// banner: 1200x300px
...
export async function resizeImage(file: File, type: ImageType): Promise<File> {
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      // Cover: riempie il canvas mantenendo l'aspect ratio, centrato
